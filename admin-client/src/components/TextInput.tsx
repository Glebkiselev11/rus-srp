...
export function TextInput({
  ...
  const showClearButton = clearable && (hover || focus) && value;

  const onFocusLabelClasses =
    "top-[-7px] bg-white px-0.5 text-xs text-indigo-700";
  ...
  const inputClasses = [
    "border h-[48px] px-4 w-full border-2 rounded-md outline-indigo-700",
    className,
  ].join(" ");
